SELECT * FROM public.retail_sales ORDER BY transactions_id ASC
-- DATA CLEANING
...
SELECT * FROM public.retail_sales ORDER BY transactions_id ASC LIMIT 100
...
SELECT
category,
COUNT(DISTINCT customer_id) as cnt_uni_customer
FROM retail_sales
GROUP BY 1;
